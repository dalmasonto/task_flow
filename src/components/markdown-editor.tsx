    ...
    <div className={cn('space-y-2', className)}>
      ...
      {preview ? (
        ...
        <textarea
          ...
          rows={rows}
          className="w-full bg-input border-0 border-b border-border focus:border-secondary focus:ring-0 text-sm py-4 px-0 placeholder:text-muted-foreground/30 resize-none"
        />
      )}
    </div>
  )
